...
seoTitle: "MCP Server for NZ Interest Rates"
description: "Connect AI agents to New Zealand mortgage and loan rates. Use the free MCP endpoint, the OpenAPI JSON for tool generation, and llms.txt."
---
...
| Full documentation for LLMs | [`/llms-full.txt`](/llms-full.txt) | The full text of all documentation pages in one Markdown file |
