---
title: "Quickstart"
seoTitle: "Quickstart: Get NZ Mortgage Rates as JSON"
description: "Get New Zealand mortgage rates as JSON with one curl request. Filter by term, get the rates of one bank, and get earlier rates. No API key."
---
