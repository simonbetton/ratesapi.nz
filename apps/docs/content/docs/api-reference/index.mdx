---
title: "API Reference"
description: "The base URL, the endpoint groups, the filters, the response rules, and the time-series rules of Rates API."
---
...
The health endpoint, `GET /api/v1/health`, shows if the API can read its database. It also shows the time of the last change to each dataset.
