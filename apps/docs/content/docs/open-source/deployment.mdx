---
title: "Deployment"
seoTitle: "Deploy Rates API to Cloudflare Workers"
description: "Deploy your own New Zealand interest rates API to Cloudflare Workers: prepare D1, set the Worker routes, build, and set GitHub Actions secrets."
---
