---
title: "Open Source"
seoTitle: "Open Source NZ Rates API: Architecture"
description: "How the open source New Zealand rates API is built: Cloudflare Workers, D1, Elysia, hourly scrapers, and the repository layout. MIT licensed."
---
