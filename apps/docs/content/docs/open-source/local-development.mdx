...
seoTitle: "Run the NZ Rates API Locally"
description: "Clone Rates API, install it with Bun, start the API, docs, and landing page, and load real New Zealand rate data into a local D1 database."
---
